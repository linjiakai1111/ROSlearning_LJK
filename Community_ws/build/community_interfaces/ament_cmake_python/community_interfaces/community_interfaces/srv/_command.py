...
class Metaclass_Command(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'community_interfaces.srv.Command')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from community_interfaces.srv import _command
...
class Command(metaclass=Metaclass_Command):
    from community_interfaces.srv._command import Command_Request as Request
    from community_interfaces.srv._command import Command_Response as Response
