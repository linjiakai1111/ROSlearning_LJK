...
#include "community_interfaces/srv/detail/command__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = community_interfaces::srv::Command_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const community_interfaces::srv::Command_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<community_interfaces::srv::Command_Request *>(
    untyped_ros_message);
...
{
  return &community_interfaces::srv::typesupport_fastrtps_cpp::_Command_Request__handle;
}
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = community_interfaces::srv::Command_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const community_interfaces::srv::Command_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<community_interfaces::srv::Command_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &community_interfaces::srv::typesupport_fastrtps_cpp::_Command_Response__handle;
}
...
{
  return &community_interfaces::srv::typesupport_fastrtps_cpp::_Command__handle;
}
