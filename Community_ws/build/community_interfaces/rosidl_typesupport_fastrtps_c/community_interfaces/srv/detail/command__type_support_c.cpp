...
#include "community_interfaces/srv/detail/command__rosidl_typesupport_fastrtps_c.h"
...
using _Command_Request__ros_msg_type = community_interfaces__srv__Command_Request;
...
size_t get_serialized_size_community_interfaces__srv__Command_Request(
  const void * untyped_ros_message,
...
static uint32_t _Command_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_community_interfaces__srv__Command_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_community_interfaces
size_t max_serialized_size_community_interfaces__srv__Command_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = community_interfaces__srv__Command_Request;
    is_plain =
      (
...
static size_t _Command_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_community_interfaces__srv__Command_Request(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, community_interfaces, srv, Command_Request)() {
...
using _Command_Response__ros_msg_type = community_interfaces__srv__Command_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_community_interfaces
size_t get_serialized_size_community_interfaces__srv__Command_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Command_Response__ros_msg_type * ros_message = static_cast<const _Command_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_community_interfaces__srv__Command_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_community_interfaces
size_t max_serialized_size_community_interfaces__srv__Command_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = community_interfaces__srv__Command_Response;
    is_plain =
      (
...
static size_t _Command_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_community_interfaces__srv__Command_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, community_interfaces, srv, Command_Response)() {
...
// already included above
// #include "community_interfaces/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "community_interfaces/srv/command.h"
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, community_interfaces, srv, Command)() {
