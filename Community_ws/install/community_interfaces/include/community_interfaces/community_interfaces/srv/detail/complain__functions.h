...
#ifndef COMMUNITY_INTERFACES__SRV__DETAIL__COMPLAIN__FUNCTIONS_H_
#define COMMUNITY_INTERFACES__SRV__DETAIL__COMPLAIN__FUNCTIONS_H_
...
/// Initialize srv/Complain message.
/**
...
/// Create srv/Complain message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * community_interfaces__srv__Complain_Request__init().
...
/// Destroy srv/Complain message.
/**
 * It calls
 * community_interfaces__srv__Complain_Request__fini()
...
/// Check for srv/Complain message equality.
/**
...
/// Initialize array of srv/Complain messages.
/**
...
/// Finalize array of srv/Complain messages.
/**
 * It calls
 * community_interfaces__srv__Complain_Request__fini()
...
/// Create array of srv/Complain messages.
/**
 * It allocates the memory for the array and calls
 * community_interfaces__srv__Complain_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/Complain messages.
/**
 * It calls
 * community_interfaces__srv__Complain_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/Complain message array equality.
/**
...
/// Copy an array of srv/Complain messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * community_interfaces__srv__Complain_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_community_interfaces
...
/**
 * It calls
 * community_interfaces__srv__Complain_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_community_interfaces
...
/**
 * It allocates the memory for the array and calls
 * community_interfaces__srv__Complain_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_community_interfaces
...
/**
 * It calls
 * community_interfaces__srv__Complain_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // COMMUNITY_INTERFACES__SRV__DETAIL__COMPLAIN__FUNCTIONS_H_
